...
public interface CPP14ParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link CPP14Parser#macroDefParamList}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMacroDefParamList(CPP14Parser.MacroDefParamListContext ctx);
	/**
	 * Visit a parse tree produced by {@link CPP14Parser#macroDefParam}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMacroDefParam(CPP14Parser.MacroDefParamContext ctx);
	/**
	 * Visit a parse tree produced by {@link CPP14Parser#specialMacroParam}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSpecialMacroParam(CPP14Parser.SpecialMacroParamContext ctx);
	/**
