...
//		final int prime = 31;
//		int result = 1;
//		int resultName = prime * result + ((name() == null) ? 0 : name().hashCode());
//		int resultType = prime * result + ((type == null) ? 0 : type.hashCode());
//        System.out.println(type + "\t" + name + "\t" + resultType+resultName );
